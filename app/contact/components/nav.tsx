...
export default function Navigation() {
  ...
  return (
    <nav className="flex items-center justify-between h-16 w-full bg-gray-50 dark:bg-gray-900 shadow-sm border-b border-white/10">
      <div className="ml-16 pc-menu">
        <ul className="flex space-x-6">
          ...
          <li
            className={`${contact && `underline`} cursor-pointer`}
